...
def find_contours_of_dices(image):
...
class MyWidget(QMainWindow):
    def __init__(self):
        ...
        self.res_home.setIcon(QIcon('/home/veronika/Desktop/my/home.png'))

        self.history_group.hide()
        self.hist_home.clicked.connect(lambda: self.change_page('start_group'))
        self.hist_home.setIcon(QIcon('/home/veronika/Desktop/my/home.png'))

        self.settings_group.hide()
        self.s_home.clicked.connect(lambda: self.change_page('start_group'))
        self.s_home.setIcon(QIcon('/home/veronika/Desktop/my/home.png'))
        self.right_btn.clicked.connect(lambda: self.time())
        self.right_btn.setIcon(QIcon('/home/veronika/Desktop/my/right.png'))
        self.left_btn.clicked.connect(lambda: self.time())
        self.left_btn.setIcon(QIcon('/home/veronika/Desktop/my/left.png'))
        self.return_test.clicked.connect(lambda: self.check())
        self.return_test.setIcon(QIcon('/home/veronika/Desktop/my/restart.png'))
        self.baraban_test.clicked.connect(lambda: self.check())
        self.baraban_test.setIcon(QIcon('/home/veronika/Desktop/my/spiral.png'))
        self.camera_test.clicked.connect(lambda: self.check())
        self.camera_test.setIcon(QIcon('/home/veronika/Desktop/my/camera.png'))

        self.start_btn.clicked.connect(lambda: self.run_count())
        self.start_btn.setIcon(QIcon('/home/veronika/Desktop/my/start.png'))
        self.inf_btn.clicked.connect(lambda: self.run_inf())
        self.inf_btn.setIcon(QIcon('/home/veronika/Desktop/my/infinity.png'))
        self.history.clicked.connect(lambda: self.change_page('history_group'))
        self.history.setIcon(QIcon('/home/veronika/Desktop/my/history.png'))
        self.settings.clicked.connect(lambda: self.change_page('settings_group'))
        self.settings.setIcon(QIcon('/home/veronika/Desktop/my/settings.png'))
    ...
    def check(self):
        if self.sender().objectName() == 'return_test':
            ...
            contours = find_contours_of_dices(gray_main_image)
